module com.itgroup.www {
    ...
    opens com.itgroup.KimKwangSuk to javafx.fxml;
    exports com.itgroup.KimKwangSuk;

    // JavaFX 애플리케이션에서 발생하는 접근 제어 문제
    // graphics 모듈이 application 폴더를 접근할 수 있도록 처리합니다.
    exports com.itgroup.Main to javafx.graphics;
    ...
    opens com.itgroup.Main to javafx.fxml;
